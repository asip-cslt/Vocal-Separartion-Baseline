...
For a quick test, you can download our pretrained model from Hugging Face and place it under `Conv-Tasnet/separation/results`. The SI-SDR result on the validation set with the pretrained model is 1.19
